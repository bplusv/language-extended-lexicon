...
<form id="mpCreateForm" action="/post/createProject" method="POST">
    <h3 class="mpTitle"><fmt:message key="new project" /></h3>
    <div class="mpField">
        <label id="mpNameLabel" for="mpName"><fmt:message key="name" />:&nbsp;</label>
        <input id="mpName" type="text" name="name" maxlength="255" />
    </div>
