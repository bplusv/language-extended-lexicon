...
--%>
            ...
            <form id="dcUpdateForm" action="<c:url value="/doUpdateDocument" />" method="POST" onsubmit="return updateDocumentData();">
            ...
            <form id="dcSymbolForm" action="<c:url value="/classify" />" method="GET">
